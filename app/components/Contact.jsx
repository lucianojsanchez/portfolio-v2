...
const Contact = () => {
    ...
    return (
        ...
        <div className="my-10 mx-auto max-w-screen-xl">
            <div className="flex items-center my-24 mx-auto max-w-screen-xl">
                <h1 className="text-4xl md:text-6xl font-bold text-gradient bg-gradient-to-r from-blue-300 to-fuchsia-800 bg-clip-text text-transparent leading-tight align-middle py-2 pr-8">Contact</h1>
                <div className="h-1 bg-gray-400/20 flex-1 mx-5"></div>
            </div>
            <div className='flex justify-center'>
                <h3 className='font-bold text-gradient bg-gradient-to-r from-pink-300 to-indigo-400 bg-clip-text text-transparent leading-tight text-2xl mb-10'>Hooked? Contact me trough these lines!</h3>
            </div>
                                ...
                                <div className='ml-6'>
                                    ...
                                    <div className="mt-1">
                                        <input
                                            ...
                                            className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-5/6 sm:text-lg border-gray-300 rounded-md text-gray-900 px-2"
                                        />
                                    </div>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <textarea
                                            ...
                                            onChange={handleChange}
                                            className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 w-5/6 sm:text-lg border-gray-300 rounded-md text-gray-900 px-2"
                                        />
                                    </div>
                                </div>
                                <div>
