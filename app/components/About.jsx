...
const AboutMe = () => {
    return (
        <div class="my-8 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8" id="about">
            <div class="flex items-center my-10 mx-auto max-w-screen-xl">
                <h1 class="text-4xl md:text-6xl font-bold text-gradient bg-gradient-to-r from-blue-600 to-indigo-800 bg-clip-text text-transparent leading-tight align-middle py-2 pr-8">
                    About Me
                </h1>
                <div class="h-1 bg-gray-400/20 flex-1 mx-5"></div>
            </div>
            <div class="mx-auto max-w-screen-xl max-xl:max-w-[90%]">
                <div class="bg-slate-900 py-12 rounded-lg">
