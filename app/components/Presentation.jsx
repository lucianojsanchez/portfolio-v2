    ...
    return (
        <div className="flex flex-col h-screen justify-center items-start mx-auto max-w-screen-xl max-xl:max-w-[80%]">
            <div>
                ...
                <h1 className="xl:text-8xl lg:text-7xl md:text-5xl max-sm:text-6xl max-[375px]:text-[48px] font-bold text-gradient bg-gradient-to-tr from-[#ab004d] to-[#7F00FF] text-transparent bg-clip-text mb-6 max-w-full ">Luciano Sanchez</h1>
